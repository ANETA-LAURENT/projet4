        ...
        <div class="card card-body bg-light mt-2">
          <div class="row mx-auto mb-2">
            <div class="form-group mr-5">
               <label for="titlecolFormLabelLg" class="col-form-label-lg">Titre: <sup>*</sup></label>
                <input type="text" name="title" class="form-control form-control-lg <?php echo (!empty($data['title_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['title']; ?>"> 
            </div>
            <div class="form-group mr-5">
            <label for="dateFormLabelLg" class="col-form-label-lg">Date: <sup>*</sup></label>
            ...
            <label for="postcolFormLabelLg" class="col-form-label-lg">Contenu: <sup>*</sup></label>
