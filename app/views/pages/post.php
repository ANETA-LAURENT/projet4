<?php require APPROOT . '/views/inc/header.php'; ?>      
 ...
 <!-- Show comment/comments -->
      <div class = "countcommentsByPostId">
        ...
        <?php foreach ($data['comments'] as $comment): ?>
         <?php echo date('d/m/Y', strtotime($comment->date_comm)); ?>
            <div class ="row"> 
              ...
              <div class="flag col-3  d-flex justify-content-end"> 
                <input type="hidden" name="id" value="<?php echo $comment->post_id; ?>">
                <span class="clickflagModal" data-toggle="modal"
                data-target="#flagModal<?php echo $comment->comm_id; ?>">Signaler ce commentaire</span>
        </div>
            </div>
            <hr> 
...
<!-- Flag the comment -->
         <form action="<?php echo URLROOT; ?>/posts/flag/<?php echo $comment->comm_id; ?>" method="post">
            <div class="modal fade" id="flagModal<?php echo $comment->comm_id; ?>" tabindex="-1" 
                  <?php echo $comment->post_id; ?> aria-hidden="true">
